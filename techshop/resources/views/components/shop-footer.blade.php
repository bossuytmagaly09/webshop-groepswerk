    ...
    <div class="border-t border-black/[0.05]">
        <div class="max-w-[1200px] mx-auto px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-[12px] text-[#666666]">
            ...
            <div class="flex items-center gap-4">
                {{-- GitHub --}}
                <a href="https://github.com" target="_blank" rel="noopener noreferrer" aria-label="GitHub" class="text-[#999999] hover:text-[#18E299] transition-colors">
                ...
                {{-- Twitter / X --}}
                <a href="https://x.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter / X" class="text-[#999999] hover:text-[#18E299] transition-colors">
                ...
                {{-- Instagram --}}
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="text-[#999999] hover:text-[#18E299] transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
